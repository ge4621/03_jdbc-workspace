...
public class MemberMenu {
	...
	public void mainMenu() {
		...
		while(true) {
			...
			System.out.println("3. 회원의 아이디 검색");
			System.out.println("4. 회원 이름으로 키워드 검색"); //selectByUserName();
			...
			case 2: mc.selectList(); break; //입력받을거 없으면 바로 controller
			case 3: String userId = inputMemberId(); 
					mc.selectByUserId(userId);
					break;
			case 4: String username = inputName(); 
	...
	public void inputMember() {
		...
		System.out.print("나이 : "); //이제부터느 문자열로 다 받자! => 웹에서는 다 문자로 넘어옴
